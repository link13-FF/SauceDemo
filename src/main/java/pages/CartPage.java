...
public class CartPage extends BasePage {
    ...
    private final String CART_URL = "/cart.html";
    private final String CART_PRODUCT_NAME =
            "//div[@class='cart_item']//div[@class='inventory_item_name'][text()='%s']";
    private final String CART_PRODUCT_PRICE =
            "//div[@class='cart_item']//div[@class='inventory_item_name'][text()='%s']/ancestor::" +
    ...
    public CartPage open() {
        log.info("CartPage Open");
        driver.get(BASE_URL + CART_URL);
        return this;
    }
    ...
    @Step ("Получение названия товара '{ProductName}'")
    public String getCartProductName(String ProductName) {
        return driver.findElement(By.xpath(String.format(CART_PRODUCT_NAME, ProductName))).getText();
    }

    @Step ("Получение стоимости товара '{ProductPrice}'")
    public String getCartProductPrice(String ProductPrice) {
        return driver.findElement(By.xpath(String.format(CART_PRODUCT_PRICE, ProductPrice))).getText();
    }
    ...
    @Step ("Продолжение оформления покупки")
